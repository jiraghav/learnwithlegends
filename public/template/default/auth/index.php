...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?=$this_folder;?>/../dist/css/style.min.css" rel="stylesheet">
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index-2.html">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="<?=$this_folder;?>/../assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="<?=$this_folder;?>/../assets/images/logo-icon.png" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="<?=$this_folder;?>/../assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text -->
                                <img src="<?=$this_folder;?>/../assets/images/logo-light-text.png" class="light-logo" alt="homepage" />
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="<?=$this_folder;?>/../assets/images/users/profile-pic.jpg" alt="user" class="rounded-circle"
                                    width="40">
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="index-2.html"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="https://www.adminmart.com/docs/docs.html"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="border-top-0 px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="<?=$this_folder;?>/../assets/images/users/widget-table-pic1.jpg"
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="<?=$this_folder;?>/../assets/images/users/widget-table-pic2.jpg"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="<?=$this_folder;?>/../assets/images/users/widget-table-pic3.jpg"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="<?=$this_folder;?>/../assets/images/users/widget-table-pic4.jpg"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
    ...
    <script src="<?=$this_folder;?>/../assets/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="<?=$this_folder;?>/../assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- apps -->
    <!-- apps -->
    <script src="<?=$this_folder;?>/../dist/js/app-style-switcher.js"></script>
    <script src="<?=$this_folder;?>/../dist/js/feather.min.js"></script>
    <script src="<?=$this_folder;?>/../assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="<?=$this_folder;?>/../dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="<?=$this_folder;?>/../dist/js/custom.min.js"></script>
    <!--This page JavaScript -->
    <script src="<?=$this_folder;?>/../assets/extra-libs/c3/d3.min.js"></script>
    <script src="<?=$this_folder;?>/../assets/extra-libs/c3/c3.min.js"></script>
    <script src="<?=$this_folder;?>/../assets/libs/chartist/dist/chartist.min.js"></script>
    <script src="<?=$this_folder;?>/../assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
    <script src="<?=$this_folder;?>/../assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="<?=$this_folder;?>/../assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js"></script>
    <script src="<?=$this_folder;?>/../dist/js/pages/dashboards/dashboard1.min.js"></script>
</body>
