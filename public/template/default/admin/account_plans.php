...
<div class="app-content content">
  <div class="content-wrapper">
    ...
    <div class="content-body">
      ...
      <?php $i = 1;
      foreach (SubscriptionPlan::orderBy('hierarchy')->get() as $key => $plan) : ?>
                ...
                <form class="col-12 ajax_form" method="POST" action="<?= domain; ?>/admin/update_account_plans">
                  ...
                  <div class="row">
                    ...
                    <?php foreach (SubscriptionPlan::$benefits as $key => $benefit) : ?>
                      ...
                      <div class="form-group col-md-2">
                        <label><?= $benefit['title']; ?>
                          <input type="checkbox" <?= (@$plan->DetailsArray['benefits'][$key] == 1) ? 'checked' : ''; ?> value="1" name="details[benefits][<?= $key; ?>]">
                        </label><br>
                      </div>
                    <?php endforeach; ?>
