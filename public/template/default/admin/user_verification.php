            ...
            <table class="table table-bordered table-striped">
              ...
              foreach ($documents as $document) : ?>
                <tr>
                  ...
                  <td><?= $document->Type['name']; ?><br><?= $document->DisplayStatus; ?>
                    <br>
                    <span class="badge badge-secondary"><?= date('M j, Y h:iA', strtotime($document->created_at)); ?></span>
                  </td>
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="btn-group btn-group-sm">
                        <a class="btn btn-outline-dark" href=" javascript:void(0);" onclick="open_modal('<?= domain; ?>/<?= $document->path; ?>')">View</a>
                        <a type="button" class="btn btn-outline-dark" data-toggle="modal" data-target="#processs<?= $document->id; ?>">Process</a>
                      </div>
                            ...
                            <div class="modal-body">
                              <div class="row">
                                ...
                                <div class="col-md-4">
                                  <?php
                                  $which = 'pending';
                                  $this->view('composed/user_documents', compact('user', 'which', 'document'), true); ?>
                                </div>
                      ...
                      <div class="dropdown-menu">
                        ...
                        <?php if ($document->isDocument()) : ?>
                          <a class="dropdown-item" href="javascript:void(0);" onclick="open_modal('<?= domain; ?>/<?= $document->path; ?>')">View</a>
                        <?php endif; ?>

                        <a type="button" class="dropdown-item" data-toggle="modal" data-target="#processs<?= $document->id; ?>">Process</a>
