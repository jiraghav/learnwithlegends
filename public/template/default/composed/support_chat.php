                    ...
                    <div class="card col-12" style="width: 100px;">
                      <div class="card-footer row">
                        <div class="col-8  table-">
                          <span class="media-heading">
                            ...
                            <small class="badge "><?= $ticket->customer_name; ?></small><br>
                        ...
                        <div class="col-4 ">
                          <small class="float-right "> ID: <?= $ticket->code; ?><?= $ticket->displayStatus; ?></small><br>
                        ...
                        <div class="row" style="max-height: 350px; overflow-y: scroll;">
                          ...
                          <?php foreach ($ticket->messages as $message) :
                            if ($message->admin == null) {
                              $color = "#e7e7e7";
                              $name = $message->user->fullname ?? 'user';
                            } else {
                              $name = "<i>Support</i> {$message->admin->firstname}";
                              $color = "#37373933";
                            }
                          ?>
                            <div class="col-md-12">
                              <div class=" table-bordered" style="padding: 5px;overflow: inherit;background: <?= $color; ?>;">
                                <div class="col-md-12">
                                  ...
                                  <img class="pull-left" src="http://s3.amazonaws.com/37assets/svn/765-default-avatar.png" class="-object" style="width:20px">
                                  <small class="text-small"> <?= $name; ?></small>
                                  <small class="float-right  "><i class="fa fa-clock"></i> <?= $message->created_at->format('M j, Y g:ia'); ?></small>
                      ...
                      <div class="card-footer">
                        <form method="POST" action="<?= $action; ?>" enctype="multipart/form-data">
                          <textarea id="editor1" class="form-control" required="" name="message" rows="4" placeholder="Enter Your Message"></textarea>
                          <br>

                          <input type="hidden" required="" name="ticket_code" value="<?= $ticket->code; ?>">
                          <input type="hidden" name="action" value="submit_message">
                          <input style="display:none ;" accept="image/*,application/pdf" type="file" onchange="update_screen(this);" name="documents[]" id="documents" multiple="">
                          <span id="no_of_documents">0 file(s)</span>

                          <div class="btn-group">
                            <button type="button" onclick="document.getElementById('documents').click();" class="btn btn-secondary">File</button>
