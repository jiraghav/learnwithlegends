  <section id="" class="card">
      <div class="card-header">
          ...
          <span class="badge badge-secondary"> <?= ["binary" => "Forced Matrix", "placement" => "Direct Referral"][$tree_key]; ?></span>
      ...
      <div class="card-content">
          <div class="card-body">
              ...
              <?php
                ...
                $base_url = "$domain/admin/referrals";
                  ...
                  <div class="referral col-md-12" align="center">
                      <?php
                        if ($upline['username'] == '') {
                            ...
                            $upline_link = "$base_url/$upline[username]/1/$tree_key";
                        }; ?>
                      <a href="<?= $upline_link; ?>">
                      ...
                      <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" style="max-height: 200px; overflow-y: scroll;">
                              <li>
                                  <a class="dropdown-item" href="<?= $base_url; ?>/<?= $user->username; ?>/all/<?= $tree_key; ?>">
                                      All Levels
                                  </a>
                              </li>
                              <?php for ($i = 1; $i <= 16; $i++) : ?>
                                  <li>
                                      <a class="dropdown-item" href="<?= $base_url; ?>/<?= $user->username; ?>/<?= $i; ?>/<?= $tree_key; ?>">
                                          Level <?= $i; ?>
                                      </a>
                                  </li>
                              <?php endfor; ?>
                                          ...
                                          <?php $i = 1;
                                            foreach ($list as $key => $downline) : ?>
                                              <tr>
                                                  ...
                                                  <td>
                                                      <a href="<?= $base_url; ?>/<?= $downline->username; ?>/1/<?= $tree_key; ?>">
                                                          <?= $downline->username; ?> </a>
                                                  </td>
