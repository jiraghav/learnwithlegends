...
class Rave
{
    ...
    public function verifyPayment()
    {
        ...
        if ($chargeCurrency != $payment_details['currency']) {
            Session::putFlash("danger", "###we could not complete your payment.");
            return false;
        }
    ...
    {
        $payment_details = is_array($this->order->payment_details) ? $this->order->payment_details : json_decode($this->order->payment_details, true);
